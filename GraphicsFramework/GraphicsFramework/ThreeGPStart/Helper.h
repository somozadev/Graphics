...
namespace Helpers
{
	...
	// Check for an OpenGL error and output its type if there was one
	// Can be slow if you do it a lot so disabled in release
#if defined _DEBUG	 
...
#else
	inline bool CheckForGLError() { return false; }
#endif
